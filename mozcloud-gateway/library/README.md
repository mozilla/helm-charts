...
This chart provides templates to build Gateway API-based load balancers.
...
> [!IMPORTANT]
> MozCloud library charts usually provide templates for a matching application chart, e.g. [mozcloud-gateway-lib](https://github.com/mozilla/helm-charts/tree/main/mozcloud-gateway/library) is meant to include supporting templates for [mozcloud-gateway](https://github.com/mozilla/helm-charts/tree/main/mozcloud-gateway/application). Because of that, templates in library charts often expect the same contexts as their application counterparts.
