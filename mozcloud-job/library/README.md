...
This chart provides templates to build Kubernetes Jobs and CronJobs.
...
> [!IMPORTANT]
> MozCloud library charts usually provide templates for a matching application chart, e.g. [mozcloud-job-lib](https://github.com/mozilla/helm-charts/tree/main/mozcloud-job/library) is meant to include supporting templates for [mozcloud-job](https://github.com/mozilla/helm-charts/tree/main/mozcloud-job/application). Because of that, templates in library charts often expect the same contexts as their application counterparts.
